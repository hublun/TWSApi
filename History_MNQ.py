...
class TestApp(TestWrapper, TestClient):
    ...
    def historicalDataOperations_req(self):
        ...
        # ! [reqHeadTimeStamp]
        #self.reqHeadTimeStamp(4101, ContractSamples.Fut_MNQ, "TRADES", 0, 1)
        # ! [reqHeadTimeStamp]

        # ! [reqhistoricaldata]
        queryTime = (datetime.datetime.now() - datetime.timedelta(days=4)).strftime("%Y%m%d %H:%M:%S")
        self.reqHistoricalData(2355, ContractSamples.Fut_MNQ(), queryTime,
                                "5 D", "5 secs", "TRADES", 1,1, False, [])
    ...
    def historicalData(self, reqId:int, bar: BarData):
        ...
        self.histData["volume"].append(bar.volume)
    # ! [historicaldata]
    ...
    def historicalDataEnd(self, reqId: int, start: str, end: str):
        ...
        pd.DataFrame.from_dict(self.histData).to_pickle("Data_MNQ"+start+"_"+end+".pkl",protocol=2)
    # ! [historicaldataend]
