...
#===================================================================================================
    ...
    def openOrder(self, orderId: OrderId, contract: Contract, order: Order,
        ...
        if contract.localSymbol.startswith("M2K"):
            #print("\n>>>>>>>>>>>>> M2K order submitted")
            if order.action == 'BUY':
...
#==================================================Reat time bar =============================================================
    ...
    def realTimeBarsOperations_req(self):
        ...
        # ! [reqrealtimebars]
        self.reqRealTimeBars(3001, ContractSamples.FutureM2K(), 5000, "MIDPOINT", False, [])
        # ! [reqrealtimebars]
   #========================================
    @iswrapper
    # ! [realtimebar]
    def realtimeBar(self, reqId: TickerId, time:int, open_: float, high: float, low: float, close: float,
        ...
        print(55*"{",datetime.datetime.fromtimestamp(time, tz=None),"}}}}}}}}}}}}}}}}}}}}}}}}}}")
        ...
        if cond_close_short:    
            self.placeOrder(self.nextOrderId(), ContractSamples.FutureM2K(), OrderSamples.LimitOrder("BUY", 1, round(low-0.2,1)))
            # else:
        ...
        if cond_close_long:
            self.placeOrder(self.nextOrderId(), ContractSamples.FutureM2K(), OrderSamples.LimitOrder("SELL", 1, round(high+0.2,1)))
            # else:
        ...
        print("\t>>>>>>>>>>>>>>>>>>>>Trigger: [t-Value: {0:+3.2f}] [Price: {1:>4.2f}] [Bar: {2:2.2f}]".format(t_value, close, currentBar))
        #====== order preparation ==========
        ...
        if t_value < -0.0 and self.pos_m2k > 9:
        ...
        #-----------------filtering price and existing positions ---------------------------

        # --------------- if no positions ----------------
        if abs(self.pos_m2k) < 1.0:
            self.placeOrder(self.nextOrderId(), ContractSamples.FutureM2K(), m2k_order)
            return             
        # --------------------- close positions only if a profit can make ----------------
