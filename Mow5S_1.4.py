...
#==================================================Reat time bar =============================================================
   ...
   #========================================
    ...
    def realtimeBar(self, reqId: TickerId, time:int, open_: float, high: float, low: float, close: float,
        ...
        cond_too_many_longs =  tv < -0.0 and self.pos >= (self.Max_lp-self.open_orders[0])
        cond_too_many_shorts = tv > 0.0 and self.pos <=  (self.Max_sp + self.open_orders[1])
        ...
        if fut_order.action == "SELL" and self.open_orders[1] > 0:
            print("Overselling Bye !")
            return
        if fut_order.action == "BUY" and self.open_orders[0] > 0:
