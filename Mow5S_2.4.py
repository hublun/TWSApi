   ...
   #========================================
    ...
    def realtimeBar(self, reqId: TickerId, time:int, open_: float, high: float, low: float, close: float,
        ...
        print(datetime.datetime.fromtimestamp(time, tz=None),
            "\t[Pos: {0:+2.0f} ${1:<4.2f}]".format(self.pos, self.avg_price),          
            "\t[$ {:4.2f}]".format(close),
        ...
        if cond_close_short and self.open_orders[0] < 1:
            prs = math.floor(low-self.delta*self.open_orders[0])
            self.placeOrder(self.nextOrderId(), self.contrakt, OrderSamples.LimitOrder("BUY", 1, prs))
            return
        ...
        if cond_close_long and self.open_orders[1] < 1 :
