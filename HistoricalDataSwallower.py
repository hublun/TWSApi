...
class TestApp(TestWrapper, TestClient):
    ...
    def continuousFuturesOperations_req(self):
        ...
        self.reqContractDetails(18001, self.contrakt)
        # ! [reqcontractdetailscontfut]

        # ! [reqhistoricaldatacontfut]

        #timeStr = datetime.datetime.fromtimestamp(time.time()).strftime('%Y%m%d %H:%M:%S')
        timeStr = self.endTime
        #timeStr = "20201211 16:35:00"

        self.reqHistoricalData(18002, self.contrakt, timeStr, "5 D", "5 secs", "TRADES", 0, 1, False, [])
...
#==================================================Reat time bar =============================================================
    ...
    def realTimeBarsOperations_req(self):
        ...
        # ! [reqrealtimebars]
        self.reqRealTimeBars(3001, ContractSamples.SimpleFuture(), 1000, "MIDPOINT", True, [])
        # ! [reqrealtimebars]
   #========================================
    @iswrapper
    # ! [realtimebar]
    def realtimeBar(self, reqId: TickerId, time:int, open_: float, high: float, low: float, close: float,
        ...
        #     print(self.cumsum, self.sells, "\n")
        #     self.cumsum = 0.0
        # else:
        #     if (self.cumsum<-1.0):
        #         self.buys += 1

        #         print(self.cumsum, self.buys, "\n")
        #         self.cumsum = 0.0
        #     else:
        #         print(self.buys, self.sells)
        #print(time, self.cumsum, '\n')
...
#================================================================================================================
    ...
    def historicalDataEnd(self, reqId: int, start: str, end: str):
        ...
        pd.DataFrame.from_dict(self.histData).to_pickle(os.getcwd()+"\\Data\\"+self.contrakt.symbol+
        start.split(" ")[0]+"_to_"+end.replace(" ", "").replace(":","") +".pkl", protocol=2)
    # ! [historicaldataend]
